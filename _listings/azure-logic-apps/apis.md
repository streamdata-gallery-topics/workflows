...
- name: Azure Logic Apps API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/workflows/master/_listings/azure-logic-apps/subscriptions-subscriptionid-providers-microsoft-logic-workflows-get.md
x-common:

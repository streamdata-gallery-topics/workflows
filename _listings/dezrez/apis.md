...
- name: Dezrez.Rezi.Client.Api - Allows business workflows to post system issues to
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/workflows/master/_listings/dezrez/apicoreplatformstateplatformissue-post-openapi.md
- name: Dezrez.Rezi.Client.Api - Lists the available triggers that are able to start
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/workflows/master/_listings/dezrez/apiworkflowtriggers-get-openapi.md
- name: Dezrez.Rezi.Client.Api - Lists available workflows
  x-api-slug: apiworkflowlistworkflows-get
